    ...
    internal ConnectRequestResult ProcessConnectRequest(NetConnectRequestPacket connRequest)
    {
        ...
        switch (_connectionState)
        {
            ...
            case ConnectionState.Outgoing:
                //fast check
                if (connRequest.ConnectionTime < _connectTime) return ConnectRequestResult.P2PLose;
            ...
            case ConnectionState.Connected:
                ...
                if (connRequest.ConnectionTime == _connectTime)
                    ...
                    NetManager.SendRaw(_connectAcceptPacket, this);
                //New connect request
                else if (connRequest.ConnectionTime > _connectTime) return ConnectRequestResult.Reconnection;
                break;
