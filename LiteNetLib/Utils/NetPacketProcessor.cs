...
public class NetPacketProcessor
{
    ...
    private NetDataWriter NetDataWriter { get; set; } = new();
    ...
    public void Send<T>(NetPeer peer, T packet, DeliveryMethod deliveryMethod = DeliveryMethod.ReliableOrdered)
        where T : class, new()
    {
        NetDataWriter.Reset();
    ...
    public void SendNetSerializable<T>(NetPeer peer, ref T packet,
        DeliveryMethod deliveryMethod = DeliveryMethod.ReliableOrdered) where T : INetSerializable
    {
        NetDataWriter.Reset();
